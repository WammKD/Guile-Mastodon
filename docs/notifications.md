...
> `#:excludeTypes` _keyword_ (argument position 6) <br />
> `#:accountID` _keyword_ (argument position 7) <br />
...
#### Parameters
> `mastoApp` _required_ <br />
> `#:dataAlertsFollow` _keyword_ (argument position 2) <br />
> `#:dataAlertsFavorite` _keyword_ (argument position 3) <br />
> `#:dataAlertsReblog` _keyword_ (argument position 4) <br />
> `#:dataAlertsMention` _keyword_ (argument position 5) <br />
> `#:dataAlertsPoll` _keyword_ (argument position 6) <br />
